...
Après le débrief, colle ce prompt dans ton IA avec les réponses du candidat et tes observations. L'IA te propose un scoring pour **Méthodologie** et **Utilisation de l'IA**, et suggère des questions de relance si des zones d'ombre persistent.

> **Mode d'emploi** : copie le prompt, puis colle à la suite : (1) tes observations pendant le test, (2) les réponses du candidat aux questions de débrief.
...
Pour chaque critère :
1. Score proposé avec justification basée sur les observations et réponses du candidat
2. Si les observations sont insuffisantes pour scorer un critère, propose une **question de relance** à poser au candidat

Termine par :
- Sous-total méthodologie : ___/40
- Sous-total utilisation IA : ___/25
- 2-3 points forts observés
- 2-3 points d'amélioration
- Questions de relance suggérées (si zones d'ombre)
